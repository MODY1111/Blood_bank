...
import com.example.blood_bank_mo.data.model.donationDetals.DonationDetails;
...
public interface ApiService {
    ...
    @GET("governorates")
    Call<Governorates> getListGovernorates();
    ...
    @GET("notifications")
    Call<Notifications> NotificationsList(@Query("api_token") String api_token,
                                          @Query("page") int page);

    @POST("contact")
    @FormUrlEncoded
    Call<Contact> contactUs(@Field("api_token") String api_token,
                            @Field("title") String title,
                            @Field("message") String message);

    @FormUrlEncoded
    @POST("notifications-settings")
    Call<getNotificationssettings>getnotification(@Field("api_token") String api_token);
}